...
const CreateJob = ({ onJobCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setJobType("Full-time"); setCategory("IT"); setExperience("");
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8">
            <h2 className="text-3xl font-bold text-white mb-2">Create New Job Posting</h2>
            <p className="text-blue-100">Fill in the details to post a new job opportunity</p>
          </div>
